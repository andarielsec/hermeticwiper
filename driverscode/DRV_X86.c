...
int sub_11006(wchar_t *Dest, unsigned int a2, wchar_t *Format, ...);
PDEVICE_OBJECT __stdcall sub_11040(struct _DEVICE_OBJECT *Object);
void __stdcall sub_110A4(int a1);
PDEVICE_OBJECT __stdcall sub_110C4(int a1, int Args, int a3);
int __stdcall sub_11172(int, PIRP Irp, PRKEVENT Event); // idb
int __stdcall sub_111F0(PDEVICE_OBJECT DeviceObject, PVOID Buffer, ULONG Length, union _LARGE_INTEGER StartingOffset, char); // idb
int __stdcall sub_112B2(PDEVICE_OBJECT DeviceObject, PVOID Buffer, ULONG Length, union _LARGE_INTEGER StartingOffset, char); // idb
int __stdcall sub_11374(int, PIRP Irp); // idb
int __stdcall sub_11398(int a1);
NTSTATUS __stdcall sub_113BE(int a1, PIRP Irp);
NTSTATUS __stdcall sub_11448(int a1, PIRP Irp);
NTSTATUS __stdcall sub_114D2(int a1, PIRP Irp);
int __stdcall sub_11614(int, PIRP Irp); // idb
NTSTATUS __stdcall sub_11664(int a1, IRP *DeviceObject);
PDRIVER_OBJECT __stdcall sub_1173C(PDRIVER_OBJECT DriverObject, int a2);
void __thiscall sub_117EB(void *this);
// ULONG DbgPrint(PCSTR Format, ...);
// void *__cdecl memset(void *, int Val, size_t Size);
// void *__cdecl memcpy(void *, const void *Src, size_t MaxCount);
int __stdcall sub_1184E(_WORD *a1, int a2, _DWORD *a3);
int __stdcall sub_11894(_WORD *a1, unsigned int a2, _DWORD *a3, unsigned int a4);
int __stdcall sub_118D0(wchar_t *Dest, int a2, int *a3, wchar_t *Format, va_list Args);
...
const WCHAR SourceString = 68u; // idb
...
int sub_11006(wchar_t *Dest, unsigned int a2, wchar_t *Format, ...)
{
  ...
  va_start(va, Format);
  result = sub_11894(Dest, a2 >> 1, 0, 0x7FFFFFFFu);
  if ( result >= 0 )
    return sub_118D0(Dest, a2 >> 1, 0, Format, va);
  return result;
}
...
PDEVICE_OBJECT __stdcall sub_11040(struct _DEVICE_OBJECT *Object)
{
  ...
  struct _DRIVER_OBJECT *DriverObject; // eax
  struct _UNICODE_STRING DestinationString; // [esp+4h] [ebp-8h] BYREF

  RtlInitUnicodeString(&DestinationString, &SourceString);
  for ( i = Object; ; i = IoGetLowerDeviceObject(i) )
  {
    if ( !i )
      return 0;
    DriverObject = i->DriverObject;
    if ( DriverObject )
      break;
LABEL_6:
    ;
...
PDEVICE_OBJECT __stdcall sub_110C4(int a1, int Args, int a3)
{
  ...
  if ( sub_11006(SourceString, 0x78u, (wchar_t *)L"\\Device\\Harddisk%u\\Partition0", Args, a3) )
    return 0;
  RtlInitUnicodeString(&DestinationString, SourceString);
...
// 110C4: using guessed type _DWORD Args;

//----- (00011172) --------------------------------------------------------
int __stdcall sub_11172(int a1, PIRP Irp, PRKEVENT Event)
{
...
//----- (00011374) --------------------------------------------------------
int __stdcall sub_11374(int a1, PIRP Irp)
{
...
NTSTATUS __stdcall sub_113BE(int a1, PIRP Irp)
{
  ...
  Irpa = (struct _DEVICE_OBJECT *)sub_11398((int)Irp);
  if ( Irpa )
  {
    MdlAddress = Irp->MdlAddress;
...
NTSTATUS __stdcall sub_114D2(int a1, PIRP Irp)
{
    ...
    && (v4 = *(_WORD *)(FileObject + 48), v4 > 1u) )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      v14 = RtlUnicodeStringToInteger(&String, 0xAu, &Value);
      if ( !v14 )
      {
        if ( Value < 0x64 && (v6 = sub_110C4(FileObject, Value, 0)) != 0 )
        {
          Object = v6;
          ...
          if ( AttachedDeviceReference )
          {
            ...
            Object = AttachedDeviceReference;
            v8 = sub_11040(AttachedDeviceReference);
            if ( v8 )
            {
              ObfDereferenceObject(Object);
              *(_DWORD *)(FileObject + 16) = v8;
              Irp->IoStatus.Information = 0;
            }
            else
            {
...
//----- (00011614) --------------------------------------------------------
int __stdcall sub_11614(int a1, PIRP Irp)
{
  void *v2; // eax
  void *v3; // ebx

  v2 = (void *)sub_11398((int)Irp);
  if ( v2 )
  {
...
NTSTATUS __stdcall sub_11664(int a1, IRP *DeviceObject)
{
  ...
  v4 = (struct _DEVICE_OBJECT *)sub_11398((int)DeviceObject);
  if ( v4 )
  {
    ...
    if ( DeviceObjecta )
      ObDereferenceObjectDeferDelete(DeviceObjecta);
  }
  else
  {
    Status = -1073741811;
...
PDRIVER_OBJECT __stdcall sub_1173C(PDRIVER_OBJECT DriverObject, int a2)
{
  ...
  if ( (int)DriverObjecta >= 0 )
  {
    ...
    if ( (int)DriverObjecta >= 0 )
    {
      ...
      DriverObject->MajorFunction[0] = (PDRIVER_DISPATCH)sub_114D2;
      DriverObject->MajorFunction[2] = (PDRIVER_DISPATCH)sub_11614;
      DriverObject->MajorFunction[14] = (PDRIVER_DISPATCH)sub_11664;
      DriverObject->MajorFunction[18] = (PDRIVER_DISPATCH)sub_11374;
      DriverObject->MajorFunction[3] = (PDRIVER_DISPATCH)sub_11448;
      DriverObject->MajorFunction[4] = (PDRIVER_DISPATCH)sub_113BE;
      DriverObject->DriverUnload = (PDRIVER_UNLOAD)sub_110A4;
    }
    else
    {
      IoDeleteDevice(DeviceObject);
...
NTSTATUS __stdcall DriverEntry(PDRIVER_OBJECT DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  return (NTSTATUS)sub_1173C(DriverObject, (int)RegistryPath);
}

// nfuncs=37 queued=21 decompiled=21 lumina nreq=0 worse=0 better=0
