...
int sub_11008(NTSTRSAFE_PWSTR pszDest, unsigned __int64 a2, const wchar_t *a3, ...);
void sub_11060();
__int64 __fastcall sub_1108C(__int64 a1, IRP *a2);
__int64 __fastcall sub_11284(__int64 a1, IRP *a2);
__int64 __fastcall sub_112F0(__int64 a1, __int64 a2, struct _KEVENT *a3);
__int64 __fastcall sub_11390(__int64 a1, IRP *a2);
__int64 __fastcall sub_114C8(__int64 a1, IRP *a2);
__int64 __fastcall sub_114F0(__int64 a1, IRP *a2);
__int64 __fastcall sub_11654(__int64 a1, IRP *a2);
__int64 __fastcall sub_117B8(PDRIVER_OBJECT DriverObject); // idb
void __fastcall sub_118E0(uintptr_t a1);
...
NTSTATUS __fastcall sub_11A00(const wchar_t *a1, size_t a2, size_t *a3, size_t a4);
...
int sub_11008(NTSTRSAFE_PWSTR pszDest, unsigned __int64 a2, const wchar_t *a3, ...)
{
  ...
  va_start(va, a3);
  v3 = a2 >> 1;
  result = sub_11A00(pszDest, a2 >> 1, 0i64, 0x7FFFFFFFui64);
  if ( result >= 0 )
  ...
  if ( CurrentStackLocation && (v5 = CurrentStackLocation->FileObject) != 0i64 && v5->FileName.Length > 1u )
  {
    ...
    if ( String.Buffer )
    {
      ...
      if ( !v4 )
      {
        ...
        if ( sub_11008(SourceString, v4 + 120, L"\\Device\\Harddisk%u\\Partition0", Value, v4 & v10)
          || (RtlInitUnicodeString(&DestinationString, SourceString),
              IoGetDeviceObjectPointer(&DestinationString, 0, &FileObject, &DeviceObject))
          || (ObfReferenceObject(DeviceObject),
              v6 = DeviceObject,
              v7 = DeviceObject == 0i64,
              v5->FsContext = FileObject,
              v7)
          || (AttachedDeviceReference = IoGetAttachedDeviceReference(v6)) == 0i64 )
        {
LABEL_14:
          v4 = -1073741811;
        }
        else
        {
          ...
          v5->FsContext2 = AttachedDeviceReference;
...
// 1118E: variable 'v10' is possibly undefined
// 12A90: using guessed type wchar_t aDeviceHarddisk[30];
...
LABEL_8:
  ...
  v10[-1].CompletionRoutine = (PIO_COMPLETION_ROUTINE)sub_112F0;
  v10[-1].Control = -32;
  v10[-1].Context = &Event;
...
//----- (00000000000117B8) ----------------------------------------------------
__int64 __fastcall sub_117B8(PDRIVER_OBJECT DriverObject)
{
  NTSTATUS Device; // edi
  ...
  if ( Device >= 0 )
  {
    ...
    if ( Device >= 0 )
    {
      ...
      DriverObject->MajorFunction[2] = (PDRIVER_DISPATCH)sub_11284;
      DriverObject->MajorFunction[14] = (PDRIVER_DISPATCH)sub_11390;
      DriverObject->MajorFunction[18] = (PDRIVER_DISPATCH)sub_114C8;
      DriverObject->MajorFunction[3] = (PDRIVER_DISPATCH)sub_11654;
      DriverObject->MajorFunction[4] = (PDRIVER_DISPATCH)sub_114F0;
